...
# Compiled once at module load — not rebuilt on every _meaningful_words call.
_STOP: frozenset[str] = frozenset({
    ...
    "their", "these", "those", "them", "each", "both", "such",
    "which", "whose", "itself",
    # High-frequency generic verbs (low information in context overlap)
    "does", "done", "gets", "give", "goes", "keep", "know", "look",
    "made", "much", "need", "note", "pass", "puts", "runs", "said",
    "seen", "sets", "show", "sure", "take", "tell", "used", "uses",
    "were", "work", "would", "write", "back", "come", "came", "find",
    "help", "call", "open", "read", "seem", "went",
    # Temporal and positional fillers
    "about", "after", "again", "along", "among", "around", "before",
    "below", "every", "first", "going", "last", "next", "only", "over",
    "same", "since", "soon", "time", "upon", "very", "while", "even",
    "once",
})
