...
<p align="center">
  <a href="https://github.com/Kodaxadev/Task-Anchor-MCP/actions/workflows/ci.yml">
    <img src="https://github.com/Kodaxadev/Task-Anchor-MCP/actions/workflows/ci.yml/badge.svg" alt="CI">
  </a>
</p>

<p align="center">
  <code>Python 3.11+</code> · <code>MIT License</code> · <code>108 tests</code> · <code>14 tools</code>
</p>
...
108 tests across 6 test files covering drift scoring, completion validation, model serialisation, scope validation, session lifecycle (including all git checkpoint status branches), route/tool consistency, tone switching, flow mode (including auto-expiry), and all 14 handler coroutines.
